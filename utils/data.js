...
function getBannerData(){
    var arr = [
      'http://antownimg.b0.upaiyun.com/mer/cp//atc-image-1526887472789.png',
      'http://antownimg.b0.upaiyun.com/mer/cp//atc-image-1526887472794.png',
      'http://antownimg.b0.upaiyun.com/mer/cp//atc-image-1526887472792.png',
      'http://antownimg.b0.upaiyun.com/mer/cp//atc-image-1526887648572.png']
    return arr
}
/*
 * 首页 navnav 数据
...
function getIndexNavData(){
    var arr = [
            ...
            {
                id:1,
                icon:"http://antownimg.b0.upaiyun.com/mer/images/qz.png",
                title:"亲子"
            },
            {
                id:2,
                icon:"http://antownimg.b0.upaiyun.com/mer/images/hw.png",
                title:"会务"
            },
            {
                id:3,
                icon:"http://antownimg.b0.upaiyun.com/mer/images/tj.png",
                title:"团建"
            },
            {
                id:4,
                icon:"http://antownimg.b0.upaiyun.com/mer/images/tz.png",
                title:"拓展"
            }
        ]
    return arr
...
function orderImgs(){
      var arr = [
        ...
        {
          id: 1,
          icon: "http://antownimg.b0.upaiyun.com/mer/order/1.png",
          title: "全部"
        },
        {
          id: 2,
          icon: "http://antownimg.b0.upaiyun.com/mer/order/2.png",
          title: "待确认"
        },
        {
          id: 3,
          icon: "http://antownimg.b0.upaiyun.com/mer/order/3.png",
          title: "已确认"
        },
        {
          id: 4,
          icon: "http://antownimg.b0.upaiyun.com/mer/order/4.png",
          title: "已完成"
        },
        {
          id: 5,
          icon: "http://antownimg.b0.upaiyun.com/mer/order/5.png",
          title: "已取消"
        }
      ]
      return arr
